...
from study.SRGAN.model.PIV_A_Esrgan.Module.loss import pixel_loss
from study.SRGAN.model.PIV_A_Esrgan.global_class import global_data
from study.SRGAN.model.PIV_A_Esrgan.judge_delicators import _to_np_chw, _mse, _psnr_from_mse, _energy_spectrum_mse, \
...
def validate_raft(model, dataloader, device, epoch):
    ...
    avg_aee = total_aee if global_data.esrgan.USE_RAFT else float("nan")
    avg_norm_aee_per100 = total_norm_aee_per100 if global_data.esrgan.USE_RAFT else float("nan")
