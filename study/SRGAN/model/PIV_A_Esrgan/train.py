...
from study.SRGAN.model.PIV_A_Esrgan.visual_plot_init import build_flo_uvw_fake_panel
from study.SRGAN.model.PIV_A_Esrgan.visual_plot_save import save_vorticity_quiver_single
...
def esrgan_union_RAFT_train(
    ...
    metric_values = [
        ...
        loss_dict["pixel_fft"],
        loss_dict["flow_warp_consistency_loss"],
        loss_dict["flow_warp_consistency_weighted_loss"],
